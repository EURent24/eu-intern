  ...
  for (var i = 0, iLen = iomnames.length; i < iLen; i +=1) {
    global[iomnames[i]] = (function () {
      var domainPrefix = "5eff6a41",
          ...
          cookieName = "ioam2018",
          cookieMaxRuns = 0,
          socioToken = "f135d57499007f649c08943ba66a5f02",
      ...
      function buildResult(params) {
        ...
        result.xy = getScreen();
        result.lo = "DE/Land Berlin";
        result.cb = "0011";
        result.i2 = "0011084865937d02d649c0894";
        result.ep = parseInt('1716210607', 10);
        result.vr = "434";
